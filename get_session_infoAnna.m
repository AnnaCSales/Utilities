function info = get_session_infoAnna(directory, fn_pf)
% this version has been hacked to recognise a settings file with a postfix,
% even when there is just one such file in the folder.
